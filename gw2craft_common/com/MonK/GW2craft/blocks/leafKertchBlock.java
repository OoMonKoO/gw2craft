...
public class leafKertchBlock extends BlockLeavesBase implements IShearable{
    
    public static final String[] LEAF_TYPES = new String[] {"kertch"};
    public static final String[][] field_94396_b = new String[][] {{"leaves_kertch"}, {"leaves_kertch_opaque"}};
    ...
    public leafKertchBlock(int par1)
    {
    ...
    {
        if ((par1 & 3) == 0) {
        return ColorizeLeaves.getFoliageColorKertch();
        }
        else {
            return ColorizeLeaves.getFoliageColorKertch();
        }
    ...
    {
        return Blocks.saplingKertchBlock.blockID;
    }
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        for (int i = 0; i < field_94396_b.length; ++i)
        {
            ...
            {
                this.iconArray[i][j] = par1IconRegister.registerIcon("GW2craft:" + field_94396_b[i][j]);
            }
        }
    }
