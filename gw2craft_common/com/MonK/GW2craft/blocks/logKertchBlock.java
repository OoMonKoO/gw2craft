...
public class logKertchBlock extends BlockRotatedPillar 
{
    
    /** The type of tree this log came from. */
    public static final String[] woodType = new String[] {"kertch"};
    @SideOnly(Side.CLIENT)
    private Icon[] field_111052_c;
    @SideOnly(Side.CLIENT)
    private Icon[] tree_top;

    public logKertchBlock(int par1)
    {
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        ...
        {
            this.field_111052_c[i] = par1IconRegister.registerIcon("GW2craft:log_" + woodType[i]);
            this.tree_top[i] = par1IconRegister.registerIcon("GW2craft:log_" + woodType[i] + "_top");
        }
    }
